...
public class MultipleInputStreamTaskTest {
     ...
     * things. The first one should take into account only records coming in from the network, while
     * ignoring records produced inside the task itself (like via a chained source). The main
     * operator should, on the other hand, report all records from all of the inputs (regardless
     * if it's a network or chained input).
     */
    @Test
